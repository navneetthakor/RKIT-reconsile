...
namespace WebApplication1.Helper_Classes
{
    public class JWT
    {
        ...
        public static ClaimsPrincipal ValidateJwtToken(string token, out string email)
        {
            email = null;
            ...
            try
            {
                ...
                result = tokenHandler.ValidateToken(token, validationParameters, out validatedToken);
